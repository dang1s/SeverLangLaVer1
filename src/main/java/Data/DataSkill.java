...
public class DataSkill {
    ...
    public static Skill[] skills_0 = new Skill[]{
            DataCenter.gI().getSkillWithIdAndLevel(SkillTemplate.KIEM_THUAT_CO_BAN, 1),};
    public static Skill[] skills_1 = new Skill[]{
            DataCenter.gI().getSkillWithIdAndLevel(SkillTemplate.KIEM_THUAT_CO_BAN, 1),
    ...
    public static Skill[] skills_2 = new Skill[]{
            DataCenter.gI().getSkillWithIdAndLevel(SkillTemplate.KIEM_THUAT_CO_BAN, 1),
    ...
    public static Skill[] skills_3 = new Skill[]{
            DataCenter.gI().getSkillWithIdAndLevel(SkillTemplate.KIEM_THUAT_CO_BAN, 1),
    ...
    public static Skill[] skills_4 = new Skill[]{
            DataCenter.gI().getSkillWithIdAndLevel(SkillTemplate.KIEM_THUAT_CO_BAN, 1),
    ...
    public static Skill[] skills_5 = new Skill[]{
            DataCenter.gI().getSkillWithIdAndLevel(SkillTemplate.KIEM_THUAT_CO_BAN, 1),
    ...
    public static Skill[] skills_57 = new Skill[]{
    ...
    public static Skill[] skills_60 = new Skill[]{
