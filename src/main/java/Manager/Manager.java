...
//            {1,1,1,5,1,500000,2,2,10,200,1,1,1,50,1,10,1000000,3,100,20,1,1,300000,1}
    ...
    public short[][] listTVM = {//tvm vang
            {9, 163, 10, 353, 763, 465, 163, 428, 564, 8, 354, 565, 9, 163, 562, 687, 563, 192, 566, 192, 567, 526, 8, 163},
    ...
    public int[][] amountTVM = {
            {1, 2000000, 1, 2, 8, 1, 1000000, 6, 5, 1, 5, 2, 1, 5000000, 5, 75, 2, 1000, 5, 500, 2, 1, 1, 5000000},
