...
//            }
            ...
            if (isOk) {
                ...
                if(code.equals("mocnap1")){

                    if(_myChar.Info.rank < 1){

                        _myChar.service.alertMessage("Mã quà tặng này cần rank1 để sử dụng");
                ...
                if(code.equals("mocnap2")){

                    if(_myChar.Info.rank < 2){

                        _myChar.service.alertMessage("Mã quà tặng này cần rank2 để sử dụng");
                ...
                if(code.equals("mocnap32")){

                    if(_myChar.Info.rank < 3){

                        _myChar.service.alertMessage("Mã quà tặng này cần rank3 để sử dụng");
                ...
                if(code.equals("mocnap42")){

                    if(_myChar.Info.rank < 4){

                        _myChar.service.alertMessage("Mã quà tặng này cần rank4 để sử dụng");
                ...
                if(code.equals("mocnap5")){

                    if(_myChar.Info.rank < 5){

                        _myChar.service.alertMessage("Mã quà tặng này cần rank5 để sử dụng");
                ...
                if(code.equals("mocnap6")){

                    if(_myChar.Info.rank < 6){

                        _myChar.service.alertMessage("Mã quà tặng này cần rank6 để sử dụng");
                ...
                if(code.equals("mocnap7")){

                    if(_myChar.Info.rank < 7){

                        _myChar.service.alertMessage("Mã quà tặng này cần rank7 để sử dụng");
                ...
                if(code.equals("mocnap8")){

                    if(_myChar.Info.rank < 8){

                        _myChar.service.alertMessage("Mã quà tặng này cần rank8 để sử dụng");
                ...
                if(code.equals("mocnap9")){

                    if(_myChar.Info.rank < 9){

                        _myChar.service.alertMessage("Mã quà tặng này cần rank9 để sử dụng");
                ...
                if(code.equals("mocnap11")){

                    if(_myChar.Info.rank < 11){

                        _myChar.service.alertMessage("Mã quà tặng này cần rank11 để sử dụng");
                ...
                if(code.equals("mocnap12")){

                    if(_myChar.Info.rank < 12){

                        _myChar.service.alertMessage("Mã quà tặng này cần rank12 để sử dụng");
                ...
                if(code.equals("mocnap13")){

                    if(_myChar.Info.rank < 13){

                        _myChar.service.alertMessage("Mã quà tặng này cần rank13 để sử dụng");
                ...
                if(code.equals("mocnap14")){

                    if(_myChar.Info.rank < 14){

                        _myChar.service.alertMessage("Mã quà tặng này cần rank14 để sử dụng");
...
//
                ...
                if(code.equals("testvinhvien") || code.equals("code1thang4") || code.equals("quatang") || code.equals("giangsinhanlanh2")){
                ...
                if(code.equals("tanthu1") || code.equals("tanthu2") || code.equals("tanthu3")){

                    if(!_myChar.user.actived || _myChar.level() < 48){

                        _myChar.service.alertMessage("Cần kích hoạt và đạt lv 48 trở lên!");
