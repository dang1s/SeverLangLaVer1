...
public class Summer extends Event {
    ...
    public Summer() {
        ...
        itemsThrownFromMonsters.add(60, -1);
        keyEventPoint.add(TOP_LAM_KEM);
        keyEventPoint.add(EventPoint.DIEM_TIEU_XAI);
        keyEventPoint.add(TOP_FISH);
        menuKhaTienNu = "Làm hũ kem,1 cái,10 cái,100 cái,Hướng dẫn;Giải cứu Tiên Nhân,Tham gia(500 vàng),Từ chối;BXH Top Làm Kem;BXH Top Câu Cá;Kiểm tra điểm sự kiện;Đổi điểm,Túi cấp 4, Thẻ đổi tên, Cải trang Madara, Cải trang Madara Lục Đạo, Cải trang Kakashi Lục Đạo";
    }
                    ...
                    case 0:
                        ...
                        if (p.level() > 44) {
                            if (p.getGroup() != null) {
                                ...
                                if (checkVang) {
                                    p.service.alertMessage("Có thành viên trong tổ đội không đủ 100 vàng");
                                    return;
                                }
            ...
            case 5:
                ...
                switch (index2){
                    ...
                    case 2:
                        point = p.getEventPoint().getPoint(EventPoint.DIEM_TIEU_XAI);
                        if(point < 20000){
                            p.service.serverMessage("Bạn không có đủ 20000 điểm tiêu sài");
                            return;
                        }
                        p.getEventPoint().subPoint(EventPoint.DIEM_TIEU_XAI,20000);
