    ...
    public void updateMob(Mob mob, Zone zone) {
        ...
        try {
            ...
            switch (eff.id) {
                ...
                case 9: // Trúng độc (Mob) - damage scale theo poison stat attacker, random 30-100%

                    if (System.currentTimeMillis() - delay >= 350) {

                        int dame = value * 6;

                        dame = Utlis.nextInt(dame * 3 / 10, dame);

                        if (dame > 0 && mob.hp - dame > 0) {
    ...
    public void update(Char aThis) {
        ...
        try {
            ...
            switch (eff.type) {
                ...
                case 2: // Trúng độc (Char/PvP) - damage scale theo poison stat attacker, random 90-100%
                    ...
                    if (System.currentTimeMillis() - delay >= 350) {
                        ...
                        if (dame > 0 && aThis.Point.hp - dame > 0) {
