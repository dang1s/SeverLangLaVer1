...
public class History {
    ...
    public void setBefore(int bac, int backhoa, int vang,int vangkhoa) {
        this.befores.put("bac", bac);
        this.befores.put("backhoa", backhoa);
        this.befores.put("vang", vang);
        this.befores.put("vangkhoa", vangkhoa);
    }

    public void setAfter(int bac, int backhoa, int vang,int vangkhoa) {
        this.afters.put("bac", bac);
        this.afters.put("backhoa", backhoa);
        this.afters.put("vang", vang);
        this.afters.put("vangkhoa", vangkhoa);
    }
