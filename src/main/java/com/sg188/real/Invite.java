...
public class Invite {
    ...
    public void addCharInvite(byte type, String name, int time) {
        List<PlayerInvite> v = list.get(type);
        v.add(new PlayerInvite(name, time));
    }
    ...
    public PlayerInvite findCharInvite(byte type, String name) {
        List<PlayerInvite> v = list.get(type);
        for (PlayerInvite in : v) {
    ...
    public class PlayerInvite {
        ...
        public PlayerInvite(String name, int time) {
            this.name = name;
            this.time = time;
        }
