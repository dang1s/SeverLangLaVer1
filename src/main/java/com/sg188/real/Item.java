...
public class Item implements Cloneable {
    ...
    public static void getOptionCaiTrang(Item item) {
        ...
        if (level >= 10) {
            ...
            item.addItemOption(new ItemOption(3, 10 + (level - 10) / 2 * 5));
    ...
    public static void getOptionCanh(Item item) {
        ...
        if (level >= 1) {
            ...
            item.addItemOption(new ItemOption(305, 0, 190000, 190000));
    ...
    public static void getOptionMat(Item item) {
...
//                        var3.add(new ItemOption("385,500,-1")); //(+28) Kháng tất cả: +#
    ...
    public void updateOption_4() {//vô cực
        ...
        var3.add(new ItemOption("386,200,-1"));//(+30) Hồi MP mỗi giây: +#"

        var3.add(new ItemOption("392,2,-1"));//(+30) Giảm +#% thời gian hồi kĩ năng

        var3.add(new ItemOption("387,200,-1"));//(+32) Hồi HP mỗi giây: +#

        var3.add(new ItemOption("393,2,-1"));//(+32) Tốc độ đánh của kĩ năng: +#%

        var3.add(new ItemOption("388,2,-1"));//(+34) Miễn giảm sát thương: +#%

        var3.add(new ItemOption("394,2,-1"));//(+34) Tăng công kích kĩ năng: +#%
...
//                            var3.add(new ItemOption("382,200,-1")); //(+22) Bỏ qua né tránh: +#
    ...
    public void updateCanh(int i) { // update mắt

        if (this.getItemTemplate().type != 17) {
    ...
    public void updateMat(int i) { // update cánh

        if (this.getItemTemplate().type != 18) {
...
//                            var3.add(new ItemOption("382,200,-1")); //(+22) Bỏ qua né tránh: +#
    ...
    public boolean checkFullTuLuyencanh() {
        ...
        try {
            ...
            if (this.getItemTemplate().type == 18 && (var2 = var1[0]).a[1] == var1[0].f()) {
    ...
    public boolean checkFullTuLuyenmat() {
        ...
        try {
            ...
            if (this.getItemTemplate().type == 17 && (var2 = var1[0]).a[1] == var1[0].f()) {
    ...
    public boolean checkFullHoLo() {
        ...
        try {
            ...
            if (this.getItemTemplate().type == 99 && (var2 = var1[0]).a[1] == var1[0].f()) {
    ...
    public boolean isTypeTrangBi() {
        ...
        for (int var1 = 0; var1 < DataCenter.gI().DataTypeItemBody.length; ++var1) {//ca
        ...
        if(this.getItemTemplate().type <= 18) //cánh
    ...
    public boolean isItemBody() {
        ...
        return this.getItemTemplate().type >= 0 && this.getItemTemplate().type <= 17;
...
//        this.a(lv);
    ...
    public void createOptionCaiTrang() {
        ...
        this.strOptions = "68,5;70,5;0,300;2,75;4,75;5,25;209,70;306,10";
    ...
    public void updateLinhHon(int i) {
