...
//test cho thêm đá
        ...
        add(Card.builder().id(645).rate(0).quantity(1).build()); // than thu
        ...
        add(Card.builder().id(9).rate(15).build()); // đá 9
...
//        add(Card.builder().id(784).rate(0.5).build()); //nagato
        add(Card.builder().id(788).rate(0.1).build()); //shisui
...
//        add(Card.builder().id(911).rate(0.2).expire(EXPIRE_3_DAY).build()); //lồng đèn quả trám
        ...
        add(Card.builder().id(687).rate(10).quantity(20).build());//lông vĩ thú 10
        add(Card.builder().id(688).rate(0.5).build());//knvt
        add(Card.builder().id(860).rate(0.01).build());//knvt db
