 ...
 * @author admin
 */
public class frmEffectTemplate extends javax.swing.JFrame {

    /**
     * Creates new form frmEffectTemplate
     */
...
//                    {copyIcon, "Copy"},};
        ...
        TableCustom.apply(this, jScrollPane1, TableCustom.TableType.DEFAULT, new MouseAdapter() {
            public void mousePressed(MouseEvent e) {
                if (e.getButton() == 1) {
                    ...
                    try {
                        ...
                        updateInfo(DataCenter.gI().EffectTemplate[Integer.parseInt(String.valueOf(jTable1.getValueAt(row, 0)))]);
                    } catch (Exception ẽ) {
            ...
            private void updateInfo(EffectTemplate skillTemplate) {
                frmEffectTemplate.this.jLabel1.setText("<html>" + skillTemplate.toString() + "</html>");
            }
        });
        /*
           public short id;
   ...
   public short idIcon;
     ...
     {
         Log.debug(DataCenter.gI().EffectTemplate[i]);
     }
    ...
    void updateItem() {
        String[] columnNames = {"Id", "Icon", "Tên Hiệu Ứng"};
        Object[][] data = new Object[DataCenter.gI().EffectTemplate.length][3];
        for (int i = 0; i < data.length; i++) {
            data[i][0] = i;
            data[i][1] = new ImageIcon("DataImage\\IconClient\\" + DataCenter.gI().EffectTemplate[i].idIcon + ".png.png");
            data[i][2] = "(" + i + ") " + DataCenter.gI().EffectTemplate[i].name;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmEffectTemplate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmEffectTemplate().setVisible(true);
            }
        });
    }
