...
public class Caption {
    ...
    public static void loadVN() {
        ...
        qY = new String[]{"Cao thủ", "Nạp Vàng", "Hỏa Chí", "Chuyên cần", "Gia tộc"};
        ...
        rf = new String[]{"Tăng kinh nghiệm đánh quái", "Điểm Hỏa Chí", "Điểm chuyên cần", "Điểm chuyên cần tuần", "Điểm của cải", "Điểm của cải tuần", "Điểm cường hóa", "Điểm cường hóa tuần", "Điểm lôi đài tháng", "Điểm luyện tập", "Điểm nạp nhiều", "Điểm Hokage Đai Trán", "Điểm Hokage Áo", "Điểm Hokage Bao Tay", "Điểm Hokage Quần", "Điểm Hokage Giày", "Điểm Hokage Vũ Khí", "Điểm Hokage Dây Thừng", "Điểm Hokage Móc Sắt", "Điểm Hokage Ống Tiêu", "Điểm Hokage Túi Nhẫn Giả", "Sách tiềm năng (Sơ)", "Sách tiềm năng (Trung)", "Sách tiềm năng (Cao)", "Sách kỹ năng (Sơ)", "Sách kỹ năng (Trung)", "Sách kỹ năng (Cao)", "Bánh ít bảo"};
        ...
        rT = new String[]{"Tên", "Cấp", "Lớp", "Cấp PK", "Điểm Hỏa Chí", "Áo choàng", "Chuyên cần"};
