...
public class Caption {
    ...
    public static void loadVN() {
        ...
        mR = " + Nhận ngay 300 vàng khóa";
        mS = " + Mỗi ngày nhận thêm 20 vàng khóa và 350 vàng không khóa";
        mT = "     (nhận liên tục trong 30 ngày)";
        mU = "Hạn sử dụng: ";
        mV = "Giá: 40000 vàng";
        mW = "Phần thưởng sau khi mua:";
        mX = " + Nhận ngay 1000 vàng khóa";
        mY = " + Mỗi ngày nhận thêm 50 vàng khóa và 550  vàng không khóa";
        mZ = "     (nhận vĩnh viễn)";
        ...
        rA = new String[]{"Khu vàng", "Vàng khóa", "Khu Rank","Bạc", "Vàng", "Khuyến mãi, Shop Lục Đạo"};
